...
Open folder "json-server-data" in cmmand prompt and run command:
json-server friends.json

It will create fake rest api at http://localhost:3000/
...
3. You may want to assign array to some variable:
